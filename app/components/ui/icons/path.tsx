...
export const PhoneIconPath = ({ stroke }: IPathProps) => {
  return (
    <path
...
export const HeartIconPath = ({ stroke }: IPathProps) => {
  return (
    <path
...
export const AvatarIconPath = ({ stroke }: IPathProps) => {
  return (
    <path
...
export const ArrowIconPath = ({ stroke }: IPathProps) => {
  return (
    <path
